...
const Rolex = () => {
    const { loading, error, data} = useFetch('https://luxury-watches-store.herokuapp.com/products?title_contains=rolex')
        ...
        <div className="c2">
            ...
            <div className="container products">
                <div className='product row'>
                    {data.map(products => (
                        <div key={products.id} className='product-card col-lg-3 col-6'>
